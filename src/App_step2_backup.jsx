  ...
  if (!opened && !intro) {
    return (
      <div style={{
        ...
        {/* Main content */}
        <div style={{ position: "relative", zIndex: 10, textAlign: "center", padding: "40px", maxWidth: "560px", background: "rgba(255,255,255,0.88)", backdropFilter: "blur(18px)", border: "1px solid rgba(127,165,196,0.25)", borderRadius: "40px", boxShadow: "0 20px 80px rgba(127,165,196,0.15)" }}>
