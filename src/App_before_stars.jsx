...
const GlassCard = ({ children, style = {}, className = "" }) => (
  <div
    className={className}
    style={{
      background: "linear-gradient(135deg, rgba(212,175,55,0.08) 0%, rgba(255,253,248,0.35) 100%)",
...
function GiftItem({ label, number, name }) {
  ...
  return (
    <GlassCard style={{ padding: "20px", textAlign: "center" }}>
      <div style={{ color: "#C8A95B", fontSize: "13px", letterSpacing: "2px", textTransform: "uppercase", marginBottom: "8px" }}>
        {label}
      </div>
      <div style={{
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          right:"20px",
          bottom:"20px",
          border:"3px solid rgba(127,165,196,0.75)",
        ...
        {/* Main content */}
        <div style={{ position: "relative", zIndex: 10, textAlign: "center", padding: "50px 30px", margin: "20px", width: "calc(100% - 40px)", maxWidth: "560px", background: "rgba(255,255,255,0.88)", backdropFilter: "blur(18px)", border: "1px solid rgba(127,165,196,0.25)", borderRadius: "40px", boxShadow: "0 25px 100px rgba(79,109,138,0.22)" }}>
          ...
          <h1 style={{
            ...
            background: "linear-gradient(135deg, #4F6D8A 0%, #C8A95B 40%, #D8C08A 60%, #4F6D8A 100%)",
        ...
        <div style={{
          position: "fixed", bottom: "20px", left: "50%", transform: "translateX(-50%)",
          color: "rgba(79,109,138,0.75)", fontSize: "11px", letterSpacing: "2px",
    ...
    <div style={mainBg}>
      ...
      {[...Array(25)].map((_, i) => (
        <div key={i} style={{
          ...
          background: "#4F6D8A", borderRadius: "50%",
      ...
      <section id="cover" style={{
        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          ...
          <div style={{ color: "rgba(79,109,138,0.75)", letterSpacing: "6px", fontSize: "11px", textTransform: "uppercase", margin: "16px 0 6px" }}>
            The Wedding Of
          </div>
          <h1 style={{
            fontFamily: "'Playfair Display', serif",
      ...
      <Section id="greeting" style={{ padding: "80px 20px", textAlign: "center", maxWidth: "700px", margin: "0 auto" }}>
        <div style={{ maxWidth: "680px", margin: "0 auto" }}>
          ...
          <GoldDivider />
          <p style={{ color: "rgba(79,109,138,0.95)", lineHeight: 2, fontSize: "15px", margin: "24px 0" }}>
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{
            ...
            <GlassCard style={{ padding: "32px 24px", textAlign: "center" }}>
              ...
              <div style={{ color: "#C8A95B", fontSize: "12px", letterSpacing: "2px", marginBottom: "16px" }}>
              ...
              <div style={{
                ...
                color: "#7FA5C4", fontSize: "11px", letterSpacing: "2px",
              }}>
                PURWAKARTA
              </div>
            </GlassCard>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "24px" }}>
            {[
              ...
              <GlassCard key={title} style={{ padding: "36px 28px" }}>
                ...
                <GoldDivider />
                <div style={{ color: "#4F6D8A", fontSize: "15px", lineHeight: 2, marginTop: "16px" }}>
        ...
        <div style={{ maxWidth: "600px", margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{ position: "relative" }}>
            <div style={{
              ...
              width: "1px", background: "linear-gradient(to bottom, transparent, #C8A95B, transparent)",
              ...
              <div key={title} style={{
                ...
                <div style={{ flex: 1 }}>
                  <GlassCard style={{ padding: "20px 24px" }}>
                    <h4 style={{ fontFamily: "'Playfair Display', serif", color: "#C8A95B", fontSize: "17px", marginBottom: "6px" }}>
                      {title}
                    </h4>
                    <p style={{ color: "rgba(79,109,138,0.88)", fontSize: "13px", lineHeight: 1.7 }}>{desc}</p>
                  </GlassCard>
                </div>
                <div style={{
      ...
      <Section id="gift" style={{ padding: "80px 20px" }}>
        <div style={{ maxWidth: "700px", margin: "0 auto", textAlign: "center" }}>
          ...
          <GlassCard style={{ marginTop: "24px", padding: "20px 24px", textAlign: "left" }}>
            <div style={{ color: "#C8A95B", fontSize: "12px", letterSpacing: "2px", marginBottom: "8px" }}>
              📦 ALAMAT KIRIM HADIAH
            </div>
